...
The second, it does a little bit of work as a merchant. You can 'sell' any requisitioned items to it for half their value, and 'buy' any items listed under "Gear" (which it produces from its wicker basket full of knick-knacks). For example, you could trade in two explosive tags (200), a katana (150), and a map of Wind Country (50); this would allow you to buy up to 200 ryo of items from the cat--a telescope, for example. This may be done once a week. Any more often than that and the cat will have nothing but useless junk available in its basket (some bits of string, a clawed-up piece of fabric, and so on). Notably, it cannot provide you with poison smoke bombs.
