...
Effects: You reduce any Ground or terrain-based immobilization penalties by 2, and ignore any other mechanical effects (such as damage for walking across caltrops) if they're C-rank or lower; if they're B-rank above, you instead halve them. This does mean that you are not directly in contact with the ground (for the purposes of, say, the Doton jutsu Shindou and Yurokensei).
...
Effects: Everyone within the area of this technique takes a -4 Immobilization penalty; anyone with the Water Walking ability instead only takes a -2 penalty, which remains until you leave its area. This technique's effects remain regardless of whether you maintain its Upkeep, however while you do maintain it, you can control the syrup field to make it 'grab' someone within its area, using your CHA in place of STR to make a grapple roll against them (with you as the attacker) as a Speed 8 action; if you succeed, they are caught and take the full -4 Immobilization penalty regardless of whether or not they have the Water Walking ability.
